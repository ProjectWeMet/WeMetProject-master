...
export class TableUsersComponent implements OnInit {
  ...
  onChange(isChecked: any) {debugger
   ...
   const data2={
    ...
    userName:this.skill1.toString(),
    
    }
    this.adminDashboardService.searchUser(data2);  }

  search(){debugger
    console.log(this.active1,this.isActive.value)
     this.country1=this.country.value;
     this.skill1=this.skill.value;
     this.jobTitle1=this.jobTitle.value;
    //  this.active1=this.isActive.value;
  ...
  nameUser:any;
  constructor(public UserService:UserDashboardService,public adminDashboardService: AdminDashboardService,private router:Router) { 
    this.adminDashboardService.GetAllUsers();
    
  }
  showProfile(userId:number)
  {debugger
    this.adminDashboardService.getUserById(userId);
